...
public class ErrorView extends LinearLayout {
    ...
    /**
     * Instantiates and returns a new {@link Builder}.
     */
    public Builder set() {
    ...
    /**
     * Instantiates and returns a new {@link Builder} and sets the title of the errorview to given
     * string. Hides the subtitle.
     */
    public Builder set(String title) {
        return new Builder(this).title(title).showSubtitle(false);
    }

    /**
     * Instantiates and returns a new {@link Builder} and sets the title of the errorview to given
     * string resource. Hides the subtitle.
     */
    public Builder set(int titleRes) {
        return new Builder(this).title(titleRes).showSubtitle(false);
    }
    ...
    public class Builder {
        ...
        private Builder(ErrorView errorView) {
            this.errorView = errorView;
        }

        public Builder image(int imageRes) {
            errorView.setImage(imageRes);
            return this;
        }
        ...
        public Builder showImage(boolean show) {
            errorView.setImageVisible(show);
            return this;
        }

        public Builder imageTint(int color) {
            errorView.setImageTint(color);
            return this;
        }
        ...
        public Builder title(int titleRes) {
            errorView.setTitle(titleRes);
            return this;
        }

        public Builder titleColor(int color) {
            errorView.setTitleColor(color);
            return this;
        }
        ...
        public Builder showTitle(boolean show) {
            errorView.setTitleVisible(show);
            return this;
        }
        ...
        public Builder subtitle(int subtitleRes) {
            errorView.setSubtitle(subtitleRes);
            return this;
        }

        public Builder subtitleColor(int color) {
            errorView.setSubtitleColor(color);
            return this;
        }

        public Builder showSubtitle() {
            showSubtitle(true);
            return this;
        }

        public Builder showSubtitle(boolean show) {
            errorView.setSubtitleVisible(show);
            return this;
        }

        public Builder showRetry() {
            showRetry(true);
            return this;
        }
        ...
        public Builder retryColor(int color) {
            errorView.setRetryColor(color);
            return this;
        }
